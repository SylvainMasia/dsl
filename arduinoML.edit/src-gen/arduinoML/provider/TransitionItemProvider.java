...
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_value_feature",
								"_UI_Transition_type"),
						ArduinoMLPackage.Literals.TRANSITION__VALUE, true, false, false,
	...
	protected void addSensorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_sensor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_sensor_feature",
								"_UI_Transition_type"),
						ArduinoMLPackage.Literals.TRANSITION__SENSOR, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		SIGNAL labelValue = ((Transition) object).getValue();
